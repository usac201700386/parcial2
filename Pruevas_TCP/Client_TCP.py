...
def est_connect(hots='167.71.243.238',port=9804):
...
def Envio_TCP (filename='audio.wav',filesize=1024,host='167.71.243.238',port=9804):
...
def Recp_TCP (host='167.71.243.238',port=9804):
...
Envio_TCP(nombre,tamano,host,port)